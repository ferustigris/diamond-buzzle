...
import ferus.tigris.diamonds.data.Config;
import ferus.tigris.diamonds.data.DB;
...
import ferus.tigris.diamonds.views.ResetLevelButton;
import ferus.tigris.diamonds.views.BackgroundView;
...
public class GameView extends SurfaceView implements OnTouchListener {
	...
	public void startActivity(Intent intent) {
		gameFieldActivity.startActivity(intent);
	}
}